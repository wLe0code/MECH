...
# Cómo fue cada pregunta ya contestada, en orden ("correct"/"wrong"/"pass").
# La pantalla pinta con esto las bolitas de progreso: verde, roja o gris.
_history: list[str] = []
